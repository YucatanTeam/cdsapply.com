      ...
      .then(posts => {
        posts = posts.entries
            if((posts[0].newsletter && posts[0].title) && 
                ...
                $(".linkpost2").attr("href", "https://cdsapply.com/content.html?slug="+posts[1].slug+"&id="+posts[1]._id+"&lang=fa")
                $(".linkpost2__F").append(posts[1].title)
                $(".linkpost2__F").attr("href", "https://cdsapply.com/content.html?slug="+posts[1].slug+"&id="+posts[1]._id+"&lang=fa")
                ...
                $(".linkpost3").attr("href", "https://cdsapply.com/content.html?slug="+posts[2].slug+"&id="+posts[2]._id+"&lang=fa")
                $(".linkpost3__F").append(posts[2].title)
                $(".linkpost3__F").attr("href", "https://cdsapply.com/content.html?slug="+posts[2].slug+"&id="+posts[2]._id+"&lang=fa")
                ...
                $(".linkpost4").attr("href", "https://cdsapply.com/content.html?slug="+posts[3].slug+"&id="+posts[3]._id+"&lang=fa")
                $(".linkpost4__F").append(posts[3].title)
                $(".linkpost4__F").attr("href", "https://cdsapply.com/content.html?slug="+posts[3].slug+"&id="+posts[3]._id+"&lang=fa")
